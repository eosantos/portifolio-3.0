...
//   // Lazy initializer so the very first render already picks the correct
//   // branch. Starting with `false` and flipping after mount would unmount a
//   // GSAP-pinned tree mid-flight and crash React reconciliation (removeChild).
